export const PLACEHOLDERS = {
	...
	TEMPLATES: {
		COVER_LETTER:
			'Paste your cover letter template here…\n\nUse {{Date}}, {{My Name}}, {{My Email}}, {{My Phone}}, {{My Location}}, {{My LinkedIn}}, {{My Portfolio}}, {{My Skills}} (Grouped), {{Ungrouped Skills}}, {{Job Company}}, {{Job Title}}, {{Job Manager}}, {{Job Location}}, {{Job Address}}, {{Job Description}} for dynamic content.\n\nUse <%=Prompt Instructions%> for inline AI prompt instructions.',
		RESUME:
			'<h2>Summary</h2>\n{{summary}}\n\n<h2>Skills</h2>\n{{skills}}\n\n<h2>Experience</h2>\n{{experience}}\n\n<h2>Education</h2>\n{{education}}\n\nUse {{Date}}, {{My Name}}, {{My Email}}, {{My Phone}}, {{My Location}}, {{My LinkedIn}}, {{My Portfolio}}, {{My Skills}} (Grouped), {{Ungrouped Skills}}, {{Job Company}}, {{Job Title}}, {{Job Manager}}, {{Job Location}}, {{Job Address}}, {{Job Description}} for dynamic content.\n\nUse <%=Prompt Instructions%> for inline AI prompt instructions.',
	},
