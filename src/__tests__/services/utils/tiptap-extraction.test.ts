...
describe('extractTipTapContent', () => {
	it('should preserve empty paragraphs by converting them to <p><br></p>', () => {
		const input =
			'<div class="tiptap ProseMirror"><p><br class="ProseMirror-trailingBreak"></p><p>Some content</p><p></p></div>';
	...
	it('should handle mixed content with empty and non-empty paragraphs', () => {
		const input =
			'<div class="tiptap ProseMirror"><p>First paragraph</p><p><br class="ProseMirror-trailingBreak"></p><p>Third paragraph</p><p></p></div>';
		const expected =
			'<p>First paragraph</p><p><br></p><p>Third paragraph</p><p><br></p>';
	...
	it('should remove ProseMirror-trailingBreak elements but preserve paragraph structure', () => {
		const input =
			'<div class="tiptap ProseMirror"><p>Content with <br class="ProseMirror-trailingBreak">break</p></div>';
